...
@WebServlet(name = "StaffSearchServiceAddAvailableServlet")
public class StaffSearchServiceAddAvailableServlet extends AbstractServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("staff-service-manage-add-available-name-search") == null) {
            response.sendRedirect("staff_service_manage_add_available.jsp");
            return;
        }
        String serviceName = request.getParameter("staff-service-manage-add-available-name-search");
        ...
        if (!fpResponse.getCode().equals(FPErrorCode.SUCCESS)) {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("staff_service_manage_add_available.jsp");
