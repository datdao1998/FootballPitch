...
public class StaffCheckOutServlet extends AbstractServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        params.add("status=" + FPConstant.BookingStatus.CHECKED_IN);
        ...
        if (!fpResponse.getCode().equals(FPErrorCode.SUCCESS)) {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("staff_check_out.jsp");
            request.setAttribute("pitchesCheckOut", fpResponse.getData());
